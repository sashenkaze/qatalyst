...
export default function Solutions() {
  ...
  return (
    <section id="solutions" className="relative py-24 lg:py-28 border-y border-white/5 bg-white/[0.02]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="theme-fixed-dark inline-flex items-center gap-1 rounded-full border border-white/10 bg-ink-800 p-1 mb-8" role="tablist" aria-label="Simulation direction">
          <button
            className={`solution-tab pill-tab rounded-full px-4 py-2 text-sm font-medium border border-transparent ${
        ...
        <div className="theme-fixed-dark rounded-2xl border border-white/10 bg-ink-850 p-4 sm:p-8 overflow-x-auto">
          ...
          {activeTab === 'issuer' && (
            <div className="solution-panel">
              ...
              <svg viewBox="0 0 900 220" className="w-full h-auto min-w-[640px]" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="QAtalyst simulating the issuer, responding to requests from your acquirer or switch">
                <defs>

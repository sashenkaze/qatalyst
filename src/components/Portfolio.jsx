    ...
    <section className="relative py-24 lg:py-28 border-t border-white/5 bg-white/[0.02]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-end justify-between gap-6 flex-wrap mb-10">
          ...
          <a href="#pricing" className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 to-violet-600 text-white text-sm font-semibold px-5 py-2.5 hover:brightness-110 transition shrink-0">
            View All

    ...
    <section className="relative py-24 lg:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-5">
          <div className="graphic-panel rounded-2xl p-7 h-72 flex flex-col justify-between overflow-hidden">
            <img
          ...
          <div className="rounded-2xl border border-white/10 bg-ink-800 p-7 h-72 flex flex-col justify-between">

        ...
        <div className="relative rounded-3xl overflow-hidden border border-white/10 p-10 sm:p-14 text-center">
          ...
          <div className="relative">
            ...
            <div className="mt-9 flex flex-col sm:flex-row gap-3.5 justify-center">
              <a href="#contact-us" className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-cyan-500 to-violet-600 text-white font-semibold px-6 py-3.5 shadow-glow hover:brightness-110 transition">Start Free Sandbox</a>
              <a href="#contact-us" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 text-mist-100 font-semibold px-6 py-3.5 hover:bg-white/10 transition">Schedule Enterprise Call</a>
            </div>
